"""Thin HTTP transport around the ClaySeal REST API.
        ...
        *,
        ...
        try:
            ...
            raise TransportError(
                f"Could not reach ClaySeal at {self.base_url}: {exc}",
        ...
        if resp.status_code >= 400:
            ...
            raise TransportError(
                ...
                suggestion="Inspect the response body; this was not a structured ClaySeal error.",
