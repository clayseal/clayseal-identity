...
``DevAttestor`` is created lazily by :class:`~clayseal.client.ClaySeal`, so SDK
...
class DevAttestor:
    ...
    def _selectors_for(agent_type: str, dev_entry: str | None = None) -> list[str]:
        ...
        if dev_entry:
            selectors.append(f"k8s:pod-label:clayseal.io/dev-entry:{dev_entry}")
        return selectors
    ...
    def _ensure_anchor(self, http) -> None:
        ...
        attestor = http.post(
            ...
            json={
                ...
                "description": "clayseal-sdk dev attestor",
            },
        )
    ...
    def _ensure_entry(
        ...
        body = {
            ...
            "description": "clayseal-sdk dev entry",
        }
        if owner:
            body["owner"] = owner
        if capabilities:
    ...
    def attestation_document(
        ...
        payload = {
            ...
            "workload": {
                ...
                "k8s_sa": agent_type,
                "pod_labels": {
                    "clayseal.io/agent-type": agent_type,
                    "clayseal.io/dev-entry": dev_entry,
                },
