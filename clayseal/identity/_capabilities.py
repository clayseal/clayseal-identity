...
This is the SDK-side mirror of ``clayseal/backend/capabilities.py``. The SDK
...
# MUST stay byte-identical to clayseal/backend/capabilities.py::_AUTHORIZER_POLICY.
_AUTHORIZER_POLICY = """
