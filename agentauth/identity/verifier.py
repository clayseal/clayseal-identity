...
DEFAULT_ALLOWED_TOKEN_TYPES = ("agentauth-svid+jwt", "wit+jwt")
...
def verify_offline(
    ...
    *,
    ...
    Args:
        token: The credential JWT returned by ``AgentAuth.identify``.
    ...
    try:
        ...
        raise InvalidTokenError(
            ...
            suggestion="Pass the full JWT string returned by AgentAuth.identify().",
        ) from exc
