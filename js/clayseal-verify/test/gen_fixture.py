...
def main(out_path: str) -> None:
    ...
    fixture = {
        ...
        "headers_read": tool_headers(session, server_url=url),
        "headers_delete": tool_headers(session, server_url=url),
        "headers_wrong_root": tool_headers(session, server_url=url),
        "headers_rotation": tool_headers(session, server_url=url),
        "headers_wrong_endpoint": tool_headers(session, server_url=url),
        "headers_replay": tool_headers(session, server_url=url),
        "narrowed_headers": tool_headers(narrowed, server_url=url),
        "narrowed_headers_search": tool_headers(narrowed, server_url=url),
